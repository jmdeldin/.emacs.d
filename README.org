  ...
  (use-package ledger-mode
    ...
    (setq ledger-reports
          '(
            ...
            ("cash" "ledger -f %(ledger-file) bal Assets:Checking Assets:Savings --cleared")
            ("cc-spending" "ledger -f %(ledger-file) bal Liabilities:Credit -l 'amount < 0'")
            ("checking-cap1" "ledger -f %(ledger-file) reg Assets:Checking:CapitalOne --display 'd>=[last month]' --cleared")
            ("credit-cap1" "ledger -f %(ledger-file) reg Liabilities:Credit:CapitalOne --display 'd>=[last month]' --cleared")
            ...
            ("savings-emergency" "ledger -f %(ledger-file) reg Assets:Savings:Emergency --display 'd>=[last month]' --cleared")
            ("savings-fun" "ledger -f %(ledger-file) reg Assets:Savings:Fun --display 'd>=[last month]' --cleared")
            ("savings-fun" "ledger -f %(ledger-file) reg Assets:Savings:Fun --display 'd>=[last month]' --cleared")
            ("savings-taxes" "ledger -f %(ledger-file) reg Assets:Savings:Taxes --display 'd>=[last month]' --cleared")
